      ...
      &nbsp;
       <div class="container">
          <div class="row">
             ...
             <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <div><label>타닌 : </label><span> 6.00%</span></div> -->
                  <div class="row mt-4">
                   ...
                   <input type="text" id="quantity" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100" onchange="updateCartQuantity()">
             ...
             <p>
        <%--      <c:url var = "cartPage" value="cart.do">
             	<c:param name="product_id" value="${product.product_id }" />
             	    <c:param name="cart_quantity" value="${order_quantity}" />
             </c:url>
             
             <a href="${cartPage}" class="btn btn-primary py-3 px-5 mr-2">장바구니</a>
         --%>
