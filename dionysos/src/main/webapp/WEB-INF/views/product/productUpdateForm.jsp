                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    ...
                                    <li><a href="#IMAGES"><i class="icon nalika-picture" aria-hidden="true"></i> Pictures</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" value="${ product.product_image }">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img">
                                                                <img src="${pageContext.servletContext.contextPath}${product.product_image}.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
