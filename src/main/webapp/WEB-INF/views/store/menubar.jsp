										...
										<div class="header-right-info">
											<ul class="nav navbar-nav mai-top-nav header-right-menu">
												...
												<li class="nav-item"><a href="#" data-toggle="dropdown"
													role="button" aria-expanded="false"
													class="nav-link dropdown-toggle"> <i
														class="icon nalika-user"></i> <span class="store-name">Advanda
															Cro</span> <i class="icon nalika-down-arrow nalika-angle-dw"></i>
												</a>
													<ul role="menu"
												...
												<li class="nav-item nav-setting-open"><a href="#"
													...
													<div role="menu"
														class="storetab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated zoomIn">
