...
<c:import url="/WEB-INF/views/store/menubar.jsp" />
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Dashboard One</h2>
												<p>Welcome to Nalika <span class="bread-ntd">store Template</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        ...
        <div class="section-store container-fluid">
            <div class="row store text-center">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="store-content analysis-progrebar-ctn res-mg-t-15">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                            <div class="store-content analysis-progrebar-ctn res-mg-t-30">
