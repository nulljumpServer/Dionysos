...
<ul class="pagination">
	...
	<li class="page-item">
		<c:url var="p1" value="/storeplistView.do">
	...
	<c:if test="${ (currentPage - 10) < startPage and (currentPage - 10) > 1 }">
	<li class="page-item">
		<c:url var="pbefore" value="/storeplistView.do">
	...
	<c:forEach var="p" begin="${ startPage }" end="${ endPage }" step="1">
		...
		<li class="page-item">
			<c:url var="pp" value="/storeplistView.do">
	...
	<c:if test="${ (currentPage + 10) > endPage and (currentPage + 10) < maxPage }">
	<li class="page-item">
		<c:url var="pafter" value="/storeplistView.do">
	...
	<li class="page-item">
		<c:url var="pmax" value="/storeplistView.do">
