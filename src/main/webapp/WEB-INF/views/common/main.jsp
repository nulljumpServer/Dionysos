	...
	<div align="center">
			...
			<form action="advsearch.do" method="post">
				...
				<fieldset>
					...
					<input name='wine_origin' id="italy" type='checkbox' value="이탈리아"><label for="italy"> 이탈리아&nbsp; &nbsp;</label>
					<input name='wine_origin' id="spain" type='checkbox' value="스페인"><label for="spain"> 스페인&nbsp; &nbsp;</label>
					<input name='wine_origin' id="portuguese" type='checkbox' value="포르투갈"><label for="portuguese"> 포르투갈&nbsp; &nbsp; </label>
					<input name='wine_origin' id="germany" type='checkbox' value="독일"><label for="germany"> 독일&nbsp; &nbsp;</label>
					<input name='wine_origin' id="austria" type='checkbox' value="오스트리아"><label for="austria"> 오스트리아&nbsp; &nbsp;</label>
					<input name='wine_origin' id="america" type='checkbox' value="미국"><label for="america"> 미국&nbsp;&nbsp; </label>
					<input name='wine_origin' id="austrailia" type='checkbox' value="호주"><label for="austrailia"> 호주&nbsp; &nbsp;</label>
				...
				<fieldset>
					...
					<input name='product_price' id="30000" type='radio' value="30000"><label for="30000">	3만원 이하&nbsp;&nbsp; </label> 
					<input name='product_price' id="50000" type='radio' value="50000"><label for="50000"> 5만원 이하&nbsp;&nbsp; </label> 
					<input name='product_price' id="70000" type='radio' value="70000"><label for="70000"> 7만원 이하&nbsp;&nbsp; </label> 
