...
<ul class="pagination">
	...
	<c:if test="${ (currentPage - 10) < startPage and (currentPage - 10) > 1 }">
	<li class="page-item">
		<c:url var="pbefore" value="/nplist.do">
	...
	<c:if test="${ (currentPage + 10) > endPage and (currentPage + 10) < maxPage }">
	<li class="page-item">
		<c:url var="pafter" value="/nplist.do">
	...
	<li class="page-item">
		<c:url var="pmax" value="/nplist.do">
