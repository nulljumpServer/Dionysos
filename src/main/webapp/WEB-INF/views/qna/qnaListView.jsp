...
<style>
@font-face{
 src:url("../fonts/Stylish-Regular.woff");
 font-family : "Stylish";
}
            ...
            <div id="titleDiv">
                <form action="qsearchTitle.do" method="post">
                    <div class="search-wrap">	
                        ...
                        <input id="search" type="search" name="title" placeholder="검색어를 입력하세요.">
             ...
             <div id="writerDiv">
             	<form action="qsearchId.do" method="post">
                    <div class="search-wrap">	
                        <label for="search" class="blind"></label>
                        <input id="search" type="search" name="user_id" placeholder="검색어를 입력하세요.">
                        <button type="submit" class="btn btn-dark">검색</button> 
                        <br>
                    </div>
                </form>
