...
<tbody>
	<tr><th scope="col" class="th-title">제목</th>
		<td><input type="text" name="title" size="70" value="${qna.title}"></td>
	</tr>
	...
	<tr><th scope="col" class="th-title">내용</th>
		<td><textarea name="content" rows="5" cols="70">${qna.content}</textarea></td>
	</tr>
</tbody>
</table>
<br>
