					...
					<div class="sidebar-box ftco-animate">
						...
						<form action="psearch.do" method="post">
							<input type="hidden" name="action" value="wine_type">
								...
								<fieldset>
									<legend><img src="${pageContext.servletContext.contextPath}/resources/images/filter1.png" width="120" height="120"></legend>
									<input name='keyword' type='radio' value='레드'><label for="red">레드&nbsp; &nbsp;</label> 
									<input name='keyword' type='radio' value='화이트'><label for="white"> 화이트 &nbsp; &nbsp;</label><br> 
									<input name='keyword' type='radio'	value='스파클링'><label for="sparkling"> 스파클링 &nbsp; &nbsp; </label>
									<input name='keyword' type='radio' value='로제'><label for="rose">로제 &nbsp; &nbsp; </label><br>
								</fieldset>
								<br>
								<button class="mybtn" type='reset'>초기화</button>
								<button class="mybtn" type='submit'>검색</button>
								</form>
								<hr>
								<form action="psearch.do" method="post">
								<input type="hidden" name="action" value="wine_origin">
								<fieldset>
									<legend><img src="${pageContext.servletContext.contextPath}/resources/images/filter2.png" width="120" height="120"></legend>
									<input name='keyword' type='radio' value="프랑스"><label for="france"> 프랑스&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="이탈리아"><label for="italy"> 이탈리아&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="스페인"><label for="spain"> 스페인&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="포르투갈"><label for="portuguese"> 포르투갈&nbsp; &nbsp; </label><br>
									<input name='keyword' type='radio' value="독일"><label for="germany"> 독일&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="오스트리아"><label for="austria"> 오스트리아&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="미국"><label for="america"> 미국&nbsp;&nbsp; </label><br>
									<input name='keyword' type='radio' value="호주"><label for="austrailia"> 호주&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="뉴질랜드"><label for="newzealand"> 뉴질랜드&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="아르헨티나"><label for="argentina"> 아르헨티나&nbsp; &nbsp;</label><br>
									<input name='keyword' type='radio' value="칠레"><label for="chile"> 칠레&nbsp; &nbsp; </label><br>
									<input name='keyword' type='radio' value="남아프리카"><label for="southafrica"> 남아프리카&nbsp; &nbsp;</label>
								</fieldset>
								<br>
								<button class="mybtn" type='reset'>초기화</button>
								<button class="mybtn" type='submit'>검색</button>
								...
								<fieldset>
									<legend><img src="${pageContext.servletContext.contextPath}/resources/images/filter3.png" width="120" height="120"></legend>
									<input name='keyword' type='radio' value="10000"><label for="10000"> 1만원 이하&nbsp;&nbsp;</label> <br>
									<input name='keyword' type='radio' value="30000"><label for="30000"> 3만원 이하&nbsp;&nbsp; </label> <br>
									<input name='keyword' type='radio' value="50000"><label for="50000"> 5만원 이하&nbsp;&nbsp; </label> <br>
									<input name='keyword' type='radio' value="70000"><label for="70000"> 7만원 이하&nbsp;&nbsp; </label>  <br>
									<input name='keyword' type='radio' value="100000"><label for="100000"> 10만원 이하&nbsp;&nbsp;</label>  <br>
									<input name='keyword' type='radio' value="200000"><label for="200000"> 20만원 이하&nbsp;&nbsp; </label> <br>
									<input name='keyword' type='radio' value="500000"><label for="500000"> 50만원 이하&nbsp;&nbsp;</label> <br>
									<input name='keyword' type='radio' value="1000000"><label for="1000000"> 100만원 이하&nbsp;&nbsp;</label> <br>
								</fieldset>
								<br>
								<button class="mybtn" type='reset'>초기화</button>
								<button class="mybtn" type='submit'>검색</button>
