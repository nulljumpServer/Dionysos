		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<div>
					<p class="price">
						<span>가격 : ₩<fmt:formatNumber value="${product.product_price}" pattern="###,###,###"/></span>
					</p>	
					</div>
													...
													$.ajax({
																...
																success : function(result) {
																	if (result.trim() == "add_success") {
																		...
																		if (check) {
																			location.href = "${pageContext.servletContext.contextPath}/cart.do?product_id="
																					+ product_id
																					+ "&user_id=${loginUsers.user_id}";
																		}
						...
						<script type="text/javascript">
							$(function() {
								$(".btn-pay").click(function() {
													...
													var product_id = '${product.product_id}';
													// 현재 수량 값을 가져옵니다.
													var pay_quantity = parseInt($('#quantity').val());
													// 새로운 수량 값을 pay_quantity에 전달합니다.
													...
													$.ajax({
																...
																success : function(result) {
																	if (result.trim() == "add_success") {
																			location.href = "${pageContext.servletContext.contextPath}/pay.do?product_id="
																					+ product_id
																					+ "&user_id=${loginUsers.user_id}";
																	} /* else if (result.trim() == "already_existed") {
					...
					<div class="tab-content bg-light" id="v-pills-tabContent">
						...
						<div class="tab-pane fade show active" id="v-pills-1"
							...
							<div class="p-4">
								<p align="center">
									<img
										src="${pageContext.servletContext.contextPath}${product.wine_detail}" width="700">
								</p>
							</div>
						</div>
