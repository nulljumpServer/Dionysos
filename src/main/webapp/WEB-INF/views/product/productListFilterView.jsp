				...
				<div class="col-md-3">
						...
						<form action="advsearch.do" method="post">
							...
							<li>
								...
								<fieldset>
									...
									<input name='wine_origin' id="france" type='checkbox' value="프랑스"><label for="france"> 프랑스&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="italy" type='checkbox' value="이탈리아"><label for="italy"> 이탈리아&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="spain" type='checkbox' value="스페인"><label for="spain"> 스페인&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="portuguese" type='checkbox' value="포르투갈"><label for="portuguese"> 포르투갈&nbsp; &nbsp; </label><br>
									<input name='wine_origin' id="germany" type='checkbox' value="독일"><label for="germany"> 독일&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="austria" type='checkbox' value="오스트리아"><label for="austria"> 오스트리아&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="america" type='checkbox' value="미국"><label for="america"> 미국&nbsp;&nbsp; </label><br>
									<input name='wine_origin' id="austrailia" type='checkbox' value="호주"><label for="austrailia"> 호주&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="newzealand" type='checkbox' value="뉴질랜드"><label for="newzealand"> 뉴질랜드&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="argentina" type='checkbox' value="아르헨티나"><label for="argentina"> 아르헨티나&nbsp; &nbsp;</label><br>
									<input name='wine_origin' id="chile" type='checkbox' value="칠레"><label for="chile"> 칠레&nbsp; &nbsp; </label><br>
								...
								<fieldset>
									...
									<input name='product_price' id="10000" type='radio' value="10000"><label for="10000"> 1만원 이하&nbsp;&nbsp;</label> <br>
									<input name='product_price' id="30000" type='radio' value="30000"><label for="30000"> 3만원 이하&nbsp;&nbsp; </label> <br>
									<input name='product_price' id="50000" type='radio' value="50000"><label for="50000"> 5만원 이하&nbsp;&nbsp; </label> <br>
								...
								<li>
								<fieldset>
									<legend><img src="${pageContext.servletContext.contextPath}/resources/images/filter4.png" width="120" height="120"></legend>
					...
					타닌&nbsp;&nbsp; <input type="checkbox"	onclick="document.getElementById('tannin').disabled = !document.getElementById('tannin').disabled;"> 
						...
						<span id="value4">0</span>
								...
								<li><button type='reset' class="mybtn">초기화</button>
									<button type='submit' class="mybtn">검색</button>
								</li>
								</ul>
							</form>
