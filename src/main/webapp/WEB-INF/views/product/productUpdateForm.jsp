...
<script>
	function setThumbnail1(event) {
		...
		reader.onload = function(event) {
			// 기존 이미지 삭제
			var imageContainer1 = document.querySelector("div#image_container1");
	...
	function setThumbnail2(event) {
		...
		reader.onload = function(event) {
			// 기존 이미지 삭제
			var imageContainer2 = document.querySelector("div#image_container2");
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="review-tab-pro-inner">
							<ul id="myTab3" class="tab-review-design">
								...
								<i class="icon nalika-edit" aria-hidden="true"></i> 상품 정보 수정</a></li>
								<li><a href="#IMAGES"><i class="icon nalika-picture" aria-hidden="true"></i> 이미지 수정</a></li>
							</ul>
							<!-- 상품 정보 관리 -->
							...
							<input type="hidden" name="product_detail" value="${product.wine_detail}">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<div class="review-content-section">
													<div class="input-group mg-b-pro-edt">
														...
														<input type="text" class="form-control"	value="${ product.product_ename }" name="product_ename">
													</div>
													<div class="input-group mg-b-pro-edt">
													...
													<div class="input-group mg-b-pro-edt">
														...
														<input type="text" class="form-control"	value="${ product.wine_type }" name="wine_type">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">포도 종류 : </span> 
														<input type="text" class="form-control"	value="${ product.grape_type }" name="grape_type">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">원산지 : </span> 
														<input type="text" class="form-control"	value="${ product.wine_origin }" name="wine_origin">
													</div>
													<div class="input-group mg-b-pro-edt">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<div class="review-content-section">
													<div class="input-group mg-b-pro-edt">
														...
														<input type="text" class="form-control"	value="${ product.alcohol }" name="alcohol">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">산도 : </span>
														 <input type="text" class="form-control" value="${ product.acidity }" name="acidity">

													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">당도 : </span>
														 <input	type="text" class="form-control" value="${ product.sweetness }" name="sweetness">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">바디 : </span> 
														<input type="text" class="form-control" value="${ product.body }" name="body">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">타닌 : </span>
														 <input	type="text" class="form-control" value="${ product.tannin }" name="tannin">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">와인 용량 : </span>
														 <input type="text" class="form-control" value="${ product.wine_volume }" name="wine_volume">
													</div>
													<div class="input-group mg-b-pro-edt">
														<span class="input-group-addon">와인 생산일자 : </span>
														 <input	type="date" class="form-control" value="${ product.production_date }" name="production_date">
													</div>
												</div>
											</div>
										</div>
												...
												<div class="review-content-section">
													<div class="row">
														<div class="col-lg-4">
															...
															<div class="pro-edt-img">
																<img src="${pageContext.servletContext.contextPath}${product.product_image}" alt="" />
															</div>
														</div>
														<div class="col-lg-4">
															변경될 상품 이미지
													...
													<div class="row">
														<div class="col-lg-4">
															기존 이미지
															<div class="pro-edt-img">
																<img src="${pageContext.servletContext.contextPath}${product.wine_detail}" alt="" />
															</div>
														</div>
														<div class="col-lg-4">
															변경될 상세 이미지
