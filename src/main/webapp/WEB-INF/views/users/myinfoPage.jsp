		...
		<div class="myinfo_area">
			<div class="txt_area">
				<div class="inner_box" id="myinfoForm">
					...
					<button class="btn2 btn-gray" onclick="javascript:location.href='${myorderList}';">주문목록</button>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<c:url var="cart" value="/cart.do">
							<c:param name="user_id" value="${ users.user_id }" />
					</c:url>
					<button class="btn2 btn-gray" onclick="javascript:location.href='${cart}';">장바구니</button>
					<br>
					<br>
					<br>
					<c:url var="detailup" value="/myinfodetail.do">
							<c:param name="user_id" value="${ users.user_id }" />
					</c:url>
					<button class="btn2 btn-gray" onclick="javascript:location.href='${detailup}';">정보수정</button>

					<c:url var="myinquiry" value="/qmylist.do">
							<c:param name="user_id" value="${ users.user_id }" />
					</c:url>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%-- 					<button class="btn2 btn-gray" onclick="javascript:location.href='${myinquiry}';">환불교환</button> --%>
					<br>
					<br>
					<br>
					<c:url var="myrevlist" value="/myrevlist.do">
							<c:param name="user_id" value="${ users.user_id }" />
					</c:url>
					<button class="btn2 btn-gray" onclick="javascript:location.href='${myrevlist}';">리뷰관리</button>
					
					<c:url var="myinquiry" value="/qmylist.do">
							<c:param name="user_id" value="${ users.user_id }" />
					</c:url>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="btn2 btn-gray" onclick="javascript:location.href='${myinquiry}';">나의문의</button>
