					...
					<div class="btn_area col2">
						<form action="find_pw.do" method="post" class="input_row">
							<p>
								...
								class="pos" placeholder="아이디" style="width: 300px; height: 50px;" required><br><br>
								<input type="text" name="email" id="email"
								class="pos" placeholder="이메일" style="width: 300px; height: 50px;" required>
							</p>
							<p>
								<button type="submit" class="findbtn" id=findBtn>비밀번호 찾기</button>
