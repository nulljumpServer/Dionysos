		...
		<div class="findid_area">
			<div class="txt_area">
				<div class="inner_box" id="findid_form">
					<h2 class="logo">
                        <a href="#"><img src="${pageContext.servletContext.contextPath}/resources/images/logo.png"></a>
                    </h2>
					<h2 align="center">
						아이디 찾기
					</h2>
					<div class="btn_area col2">
						<form action="find_id.do" method="post" class="input_row">
							<p>
								<input type="text" name="email" id="email" class="pos" placeholder="이메일" style="width: 300px; height: 50px;" required>
							</p>
							<p>
								<button type="submit" class="findbtn" id="findBtn" >아이디 찾기</button>
								<button type="button" class="findbtn" onclick="history.go(-1);" >이전페이지로</button>
							</p>
						</form>
					</div>
				</div>
