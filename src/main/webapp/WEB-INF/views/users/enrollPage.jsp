					...
					<div class="inner_box" id="loginForm">
						...
						<div class="btn_area col2">
							<input type="text" name="name" placeholder="이름" title="이름"
								style="width: 300px; height: 50px;" required> <br><br>
							<input type="text" name="user_id" id="user_id" placeholder="아이디"
								title="아이디" style="width: 300px; height: 50px;" required>
							<input type="button" id="dbchk" value="중복확인"
								onclick="return dupCheckId();"> <br><br> <input
								type="password" name="password" id="upwd1" placeholder="패스워드"
								title="패스워드" style="width: 300px; height: 50px;" required>
							<br><br> <input type="password" id="upwd2" placeholder="패스워드"
								title="패스워드 확인" style="width: 300px; height: 50px;" required>
							<br><br> <input type="date" name="birthday" value="2018-07-22"
								placeholder="나이" title="나이" style="width: 300px; height: 50px;"
								min="1918-01-01" max="2020-12-31"><br><br> <input
								type="tel" name="phone" placeholder="전화번호" title="전화번호"
								style="width: 300px; height: 50px;"> <br><br> <input
								type="email" name="email" placeholder="이메일" title="이메일"
								style="width: 300px; height: 50px;" required> <br><br><br>
							<input type="submit" value="가입하기" class="btn_txt btn_black">
							&nbsp; <input type="reset" value="작성취소" class="btn_txt btn_black">
							<br><br> <a href="main.do" class="move_text">시작페이지로 이동</a>
						</div>
