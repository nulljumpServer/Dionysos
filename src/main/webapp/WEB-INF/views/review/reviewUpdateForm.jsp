...
<div id="review-list" align="center">
	<div class="container">
<form id="form1" action="rupdate.do" method="post" enctype="multipart/form-data">
...
<div align="center">
	...
	&nbsp;
	<input class="btn2 btn-gray" type="submit" value="수정하기" onclick="blankCheck();"> &nbsp;
	<script>
...
<br>
<hr>
<c:import url="/WEB-INF/views/common/footer.jsp" />4
