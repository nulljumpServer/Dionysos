...
<div id="breview-list" align="center">
	<div class="container">
<form id="form1" action="rwrite.do" method="post" enctype="multipart/form-data">
...
<tbody>
    ...
    <tr><th scope="col" class="th-title">별 점</th>
...
<div align="center">
	...
	&nbsp;
	<input class="btn2 btn-gray" type="submit" value="등록하기" onclick="blankCheck();"> &nbsp;
	<script>
    ...
    function blankCheck() {
      var review_content = document.getElementsByName('review_content')[0].value;
      var review_title = document.getElementsByName('review_title')[0].value;

      if (review_content.trim() === "" || review_title.trim() === "") {
        alert("공백을 입력해 주세요.");
        return false;
      }
      return true;
    ...
    function appendProductId() {
      ...
      var queryString = "?id=" + encodeURIComponent(product_id);
      document.getElementById('reviewForm').action += queryString;
    }
  </script>
