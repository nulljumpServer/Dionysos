package org.nulljump.dionysos.common.intercepter;
...
//public class LoginCheckInterceptor implements AsyncHandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, 
		...
		Users loginUsers = 
				(Users)session.getAttribute("loginUsers");
		
		if(loginUsers != null) {
			logger.info("로그인 상태 : " + request.getRequestURI()
						+ " 요청");			
		}else {
			logger.info("비로그인 상태 : " + request.getRequestURI()
						+ " 요청");
