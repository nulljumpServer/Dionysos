...
public class Paging {
	...
	// user_id 받는 생성자
	public Paging(int listCount, int currentPage, int limit, String url, String user_id) {
		this.listCount = listCount;
		this.currentPage = currentPage;
		this.limit = limit;
		this.url = url;
	...
	// product_id 받는 생성자
	public Paging(int listCount, int currentPage, int limit, String url, int product_id) {
		this.listCount = listCount;
		this.currentPage = currentPage;
		this.limit = limit;
		this.url = url;
	...
	//// 수정 필요 //////
	public Paging(int listCount, int currentPage,String store_id, int limit, String url) {
		this.listCount = listCount;
		this.currentPage = currentPage;
	...
	public String toString() {
		return "Paging [startRow=" + startRow + ", endRow=" + endRow + ", listCount=" + listCount + ", limit=" + limit
				...
				+ endPage + ", product_id=" + product_id + ", url=" + url + ", user_id=" + user_id + ", store_id="
				+ store_id + "]";
	}
}
